...
public class RegistryParser extends Parser {
	...
	public static final int
		HEADER=1, ENTRY=2, KEYPATH=3, VALUE=4, REG_HEADER=5, PATH=6, STRING_VALUE=7, 
		HEX_VALUE=8, DWORD_VALUE=9, COMMENTS=10, WS=11;
	public static final int
		RULE_registryFile = 0;
	...
	private static String[] makeLiteralNames() {
		return new String[] {
			null, null, null, null, null, "'REGEDIT4'"
		};
	}
	private static final String[] _LITERAL_NAMES = makeLiteralNames();
	private static String[] makeSymbolicNames() {
		return new String[] {
			null, "HEADER", "ENTRY", "KEYPATH", "VALUE", "REG_HEADER", "PATH", "STRING_VALUE", 
			"HEX_VALUE", "DWORD_VALUE", "COMMENTS", "WS"
		};
	}
	...
	public static class RegistryFileContext extends ParserRuleContext {
		...
		public List<TerminalNode> HEADER() { return getTokens(RegistryParser.HEADER); }
		public TerminalNode HEADER(int i) {
			return getToken(RegistryParser.HEADER, i);
		}
